...
function TotalOrderDelivered() {
    ...
    const [currentOrderData, setCurrentOrderData] = useState({ deliveredOrders: 0, percentageGrowth: 0 });
    ...
    const loadData = async () => {
        try {
            ...
            setCurrentOrderData(currentData || { deliveredOrders: 0, percentageGrowth: 0 });
        } catch (error) {
            console.log(error);
        }
    };
