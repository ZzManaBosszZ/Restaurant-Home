                                ...
                                <div className="product-thumb">
                                    <div id="timeline-carousel" className="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div className="carousel-indicators">
                                            <div className="product-gallery-carousel swiper">
                                                <div className="swiper-wrapper">
                                                    <div className="swiper-slide">
                                                        <div className="item active" data-bs-target="#timeline-carousel" data-bs-slide-to="0" aria-current="true">
                                                            <img src="assets/img/shop/1.png" alt="" />
                                                        </div>
                                                    </div>
                                                    <div className="swiper-slide">
                                                        <div className="item" data-bs-target="#timeline-carousel" data-bs-slide-to="1">
                                                            <img src="assets/img/shop/2.png" alt="" />
                                                        </div>
                                                    </div>
                                                    <div className="swiper-slide">
                                                        <div className="item" data-bs-target="#timeline-carousel" data-bs-slide-to="2">
                                                            <img src="assets/img/shop/3.png" alt="" />
                                                        </div>
                                                    </div>
                                                    <div className="swiper-slide">
                                                        <div className="item" data-bs-target="#timeline-carousel" data-bs-slide-to="3">
