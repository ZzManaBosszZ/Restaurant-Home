        ...
        <div>
            ...
            <div className="form-checkout mt-4">
                ...
                <label htmlFor="credit" className="form-checkout__label">
                    <div className="d-flex align-items-start flex-column">
                        <img src="./assets/images/payment/card.png" className="form-checkout__image" alt="Credit Card" />
            ...
            <div className="form-checkout">
                ...
                <label htmlFor="paypal" className="form-checkout__label">
                    <div className="d-flex align-items-start flex-column">
                        <img src="./assets/images/payment/paypal.png" className="form-checkout__image" alt="PayPal" />
